class WarCardGame:
    ...
    def __innit__(self, player, computer, deck):
        self._player = player
    ...
    def check_game_over(self):
        if self._player.has_empty_deck():
            ...
            print("        Game Over!         ")
            print("===========================")
            print(f"Excellent. You Won, {self._player.name}! Congratualations! ")
            return True
        else:
            return False
    ...
    def print_stats(self):
        ...
        print(f"The computer has {self._computer.deck.size} cards on it's deck")
        print("----")
